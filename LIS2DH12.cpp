...
uint8_t LIS2DH12::whoIAm(){
    char regAddr = (char)LIS2DH12_WHO_AM_I;
    char regData;
...
uint8_t LIS2DH12::setMode(Mode mode){
    ...
    readFromReg((char)LIS2DH12_CTRL_REG1, (uint8_t*)&ctrl1Copy, 1);
    readFromReg((char)LIS2DH12_CTRL_REG4, (uint8_t*)&ctrl4Copy, 1);
    ...
    writeToReg((char)LIS2DH12_CTRL_REG1, (uint8_t*)&ctrl1Copy, 1);
    success = writeToReg((char)LIS2DH12_CTRL_REG4, (uint8_t*)&ctrl4Copy, 1);
    return success;
}
...
int16_t LIS2DH12::readXAxis(){
    ...
    readFromReg((char)LIS2DH12_OUT_X_L, (uint8_t*)&rawData, 1);
    readFromReg((char)LIS2DH12_OUT_X_H, ((uint8_t*)&rawData)+1, 1);
...
int16_t LIS2DH12::readYAxis(){
    ...
    //rawData = (int8_t)tempData << 8;
    readFromReg((char)LIS2DH12_OUT_Y_L, (uint8_t*)&rawData, 1);
    readFromReg((char)LIS2DH12_OUT_Y_H, ((uint8_t*)&rawData)+1, 1);
...
int16_t LIS2DH12::readZAxis(){
    ...
    //rawData = (int8_t)tempData << 8;
    readFromReg((char)LIS2DH12_OUT_Z_L, (uint8_t*)&rawData, 1);
    readFromReg((char)LIS2DH12_OUT_Z_H, ((uint8_t*)&rawData)+1, 1);
...
uint8_t LIS2DH12::setScale(Scale scale){
    ...
    readFromReg((char)LIS2DH12_CTRL_REG4, (uint8_t*)&ctrl4Copy, 1);
    ctrl4Copy |= (scale << 4);
    writeToReg((char)LIS2DH12_CTRL_REG4, (uint8_t*)&ctrl4Copy, 1);
    return 0;
}
...
uint8_t LIS2DH12::int1Setup(uint8_t setup){
    char data = setup;
    writeToReg((char)LIS2DH12_CTRL_REG3, (uint8_t*)&data, 1);
    return 0;
}

uint8_t LIS2DH12::int1Latch(uint8_t enable){
    char ctrl5Copy;
    readFromReg((char)LIS2DH12_CTRL_REG5, (uint8_t*)&ctrl5Copy, 1);
    ctrl5Copy |= enable;
    writeToReg((char)LIS2DH12_CTRL_REG5, (uint8_t*)&ctrl5Copy, 1);
    return 0;
}

uint8_t LIS2DH12::int1Duration(uint8_t duration){
    char copy = duration;
    writeToReg((char)LIS2DH12_INT1_DURATION, (uint8_t*)&copy, 1);
    return 0;
}

uint8_t LIS2DH12::int1Threshold(uint8_t threshold){
    char copy = threshold;
    writeToReg((char)LIS2DH12_INT1_THS, (uint8_t*)&copy, 1);
    return 0;
}

uint8_t LIS2DH12::int1Config(uint8_t config){
    char copy = config;
    writeToReg((char)LIS2DH12_INT1_CFG, (uint8_t*)&copy, 1);
    return 0;
}

void LIS2DH12::clearIntFlag(){
    char data;
    readFromReg((char)LIS2DH12_INT1_SRC, (uint8_t*)&data, 1);
}
